        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/books"><i class="fas fa-book fa-fw"
                                                                          style="color:white"></i> <fmt:message
                ...
                <security:authorize access="isAuthenticated()">
                    <li><a href="${pageContext.request.contextPath}/user/orders"><i class="far fa-shopping-cart"
                                                                                    style="color: white"></i>
                        <fmt:message key="menu.myOrders"/></a></li>
                </security:authorize>
                <security:authorize access="hasAnyRole('ADMIN','LIBRARIAN')">
                    <li><a href="${pageContext.request.contextPath}/lib/requested-books"><i
                            class="far fa-clipboard-list" style="color: white"></i> <fmt:message
                            key="menu.requestedBooks"/></a></li>
                    <li><a href="${pageContext.request.contextPath}/lib/returned-books"><i class="far fa-hand-receiving"
                                                                                           style="color: white"></i>
                        <fmt:message key="menu.returnedBooks"/></a></li>
                    <li><a href="${pageContext.request.contextPath}/lib/addBook"><i class="fal fa-book"
                                                                                    style="color: white"></i>
                        <fmt:message key="menu.addBook"/></a></li>
                </security:authorize>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <security:authorize access="!isAuthenticated()">
                    <li><a class="btn btn-lg " href="${pageContext.request.contextPath}/login"><i
                            class="far fa-sign-in-alt" style="color: white"></i> <fmt:message key="login.Log_in"/></a>
                    </li>
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <c:if test="${language == 'ru_RU'}"> RU </c:if>
                        <c:if test="${language == 'en_US'}"> EN </c:if>
                    </a>
                    <ui class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <form action="${self}" method="POST">
                            <input name="lang_changed" value="true" hidden/>
                            <button class="btn btn-default btn-lg btn-block" name="lang" value="en_US" >
                                EN
                            </button>
                        </form>
                        <form action="${self}" method="POST">
                            <input name="lang_changed" value="true" hidden/>
                            <button class="btn btn-default btn-lg btn-block" name="lang" value="ru_RU" >
                                RU
                            </button>
                        </form>
